...
public final class SoundFXUtils {
     ...
     */
    private static final int REVERB_RAYS = DynamicSurroundings.CONFIG.enhancedSounds.reverbRays;
    /**
     * Number of bounces a sound wave will make when projecting.
     */
    private static final int REVERB_RAY_BOUNCES = DynamicSurroundings.CONFIG.enhancedSounds.reverbBounces;
    /**
     * Maximum distance to trace a reverb ray segment before stopping.
     */
    private static final float MAX_REVERB_DISTANCE = DynamicSurroundings.CONFIG.enhancedSounds.reverbRayTraceDistance;
    /**
    ...
    private static boolean skipOcclusion(SoundCategory category) {
        return !DynamicSurroundings.CONFIG.enhancedSounds.enableOcclusionProcessing
