...
public final class SoundFXProcessor {
    ...
    private static final IModLog LOGGER = DynamicSurroundings.LOGGER.createChild(SoundFXProcessor.class);
    ...
    private static final Singleton<ExecutorService> threadPool = new Singleton<>(() -> {
        int threads = DynamicSurroundings.CONFIG.enhancedSounds.backgroundThreadWorkers;
        if (threads == 0)
            threads = 2;
    ...
    static {
        ...
        ClientTickEvent.CLIENT_PRE.register(SoundFXProcessor::clientTick);
    }
