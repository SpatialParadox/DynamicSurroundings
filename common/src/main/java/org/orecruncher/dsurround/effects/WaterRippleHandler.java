...
public class WaterRippleHandler {
    ...
    private static boolean doRipples() {
        return DynamicSurroundings.CONFIG.blockEffects.waterRippleStyle != WaterRippleStyle.NONE;
    }

    private static void addWaterRipple(ClientWorld world, double x, double y, double z) {
        WaterRippleParticle ripple = new WaterRippleParticle(
                DynamicSurroundings.CONFIG.blockEffects.waterRippleStyle,
                world, x, y, z);
