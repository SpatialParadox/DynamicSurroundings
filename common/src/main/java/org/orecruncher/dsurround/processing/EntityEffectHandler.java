...
public class EntityEffectHandler  extends ClientHandler {
    ...
    private static final IModLog LOGGER = DynamicSurroundings.LOGGER.createChild(EntityEffectHandler.class);
    ...
    public void process(final PlayerEntity player) {
        ...
        var range = DynamicSurroundings.CONFIG.entityEffects.entityEffectRange;
