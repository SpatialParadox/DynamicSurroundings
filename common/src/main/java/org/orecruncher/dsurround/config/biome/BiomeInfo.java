...
public final class BiomeInfo implements Comparable<BiomeInfo>, IBiomeSoundProvider {
    ...
    private static final IModLog LOGGER = DynamicSurroundings.LOGGER.createChild(BiomeInfo.class);
    ...
    public void update(final BiomeConfigRule entry) {
        ...
        for (final AcousticConfig sr : entry.acoustics) {
            final Identifier res = SoundLibrary.resolveIdentifier(DynamicSurroundings.MOD_ID, sr.soundEventId);
    ...
    public String toString() {
        ...
        if (this.biomeId.getNamespace().equalsIgnoreCase(DynamicSurroundings.MOD_ID)) {
