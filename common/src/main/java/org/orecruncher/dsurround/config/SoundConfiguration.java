...
public class SoundConfiguration {
    ...
    private static final Path SOUND_CONFIG_PATH = DynamicSurroundings.CONFIG_PATH.resolve("soundconfig.json");
        ...
        try {
            if (Files.exists(SOUND_CONFIG_PATH)) {
                ...
                if (result.isPresent()) {
                    ...
                    DynamicSurroundings.LOGGER.warn("Unable to obtain content of soundconfig!");
                }
            }
        } catch (Throwable t) {
            DynamicSurroundings.LOGGER.error(t, "Unable to handle configuration");
        }
    ...
    private void save() {
        try {
            ...
            DynamicSurroundings.LOGGER.error(t, "Unable to save sound configuration!");
        }
    }
}
