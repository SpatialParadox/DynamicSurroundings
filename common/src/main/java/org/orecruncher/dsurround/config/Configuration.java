...
public class Configuration extends ConfigurationData {
    ...
    public Configuration() {
        super("dsurround.config", DynamicSurroundings.CONFIG_PATH.resolve(
                DynamicSurroundings.MOD_ID + ".json"));
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            DynamicSurroundings.LOGGER.error(t, "Unable to get config");
        }
        return null;
    }
    ...
    public void postLoad() {
        DynamicSurroundings.LOGGER.setDebug(this.logging.enableDebugLogging);
        DynamicSurroundings.LOGGER.setTraceMask(this.logging.traceMask);
    }
