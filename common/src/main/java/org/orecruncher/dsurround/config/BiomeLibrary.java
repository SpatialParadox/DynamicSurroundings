...
public final class BiomeLibrary {
    ...
    private static final IModLog LOGGER = DynamicSurroundings.LOGGER.createChild(BiomeLibrary.class);
    ...
    public static void load() {
        ...
        var accessors = ResourceUtils.findConfigs(DynamicSurroundings.DATA_PATH.toFile(), FILE_NAME);
