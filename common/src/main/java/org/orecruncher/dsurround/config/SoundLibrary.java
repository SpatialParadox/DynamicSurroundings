...
public final class SoundLibrary {
    ...
    private static final IModLog LOGGER = DynamicSurroundings.LOGGER.createChild(SoundLibrary.class);
    private static final Identifier MISSING_RESOURCE = new Identifier(DynamicSurroundings.MOD_ID, "missing_sound");
